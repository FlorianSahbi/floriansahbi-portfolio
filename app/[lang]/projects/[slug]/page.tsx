...
import { WithContext, WebPage, Article, ImageObject, Organization, Person } from "schema-dts"
import { notFound } from "next/navigation"

function generateJsonLd(lang: Locale, slug: string, data: EnhancedItem<typeof USE_CASES> ): Array<WithContext<WebPage> | WithContext<Article>> {
...
export default function ProjectPage({ params }: { params: { lang: Locale; slug: string } }) {
  const { lang, slug } = params
