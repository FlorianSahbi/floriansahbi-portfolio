...
meta:
  ...
  description: >
    Fullstack JavaScript Developer (Next.js, headless CMS) with deep expertise in Web Performance & SEO – 100% remote. 
    Explore my resume and projects — let’s talk about your upcoming challenges.
  canonical: "https://floriansahbi.dev/about"
  openGraph:
    title: "Fullstack JavaScript Development & Architecture – Florian Sahbi"
    description: >
      I build modular Next.js & headless applications, fully optimized for Web Performance and SEO. 
  ...
  twitter:
    ...
    title: "Fullstack JavaScript Development & Architecture – Florian Sahbi"
    description: >
      Modular, high-performance, SEO-friendly Next.js & headless applications, 
      built remotely.
    images:
...
title: "Florian Sahbi"
subTitle: "Fullstack JavaScript Development • Next.js & Headless • Web Performance & SEO"
seoTitle: "Fullstack JavaScript Developer • Next.js & SEO | Florian Sahbi"
description: >
  HETIC graduate with five years of experience in agencies, startups and scale-ups. I design and develop modern, modular JavaScript solutions using Next.js. 
  Working 100% remotely, I focus on Core Web Vitals and SEO to ensure fast, fluid user experiences and high search visibility. From initial design to final optimization, I’ve got you covered.
